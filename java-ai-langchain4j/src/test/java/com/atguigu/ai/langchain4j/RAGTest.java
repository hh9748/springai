...
public class RAGTest {
    ...
    private final String rootPath = "/Users/hh/springAI/java-ai-langchain4j/src/main/resources/knowledge";
...
//        Document document = FileSystemDocumentLoader.loadDocument(rootPath+"/测试.txt");
//        System.out.println(document.text());


        // 加载单个文档
//        Document document = FileSystemDocumentLoader.loadDocument(rootPath+"/file.txt", new TextDocumentParser());

// 从一个目录中加载所有文档
//        List<Document> documents_01 = FileSystemDocumentLoader.loadDocuments(rootPath, new TextDocumentParser());

// 从一个目录中加载所有的.txt文档
        PathMatcher pathMatcher = FileSystems.getDefault().getPathMatcher("glob:*.txt");
        PathMatcher pathMatcher2 = FileSystems.getDefault().getPathMatcher("glob:*.md");

        List<Document> documents_02 = FileSystemDocumentLoader.loadDocuments(rootPath, pathMatcher, new TextDocumentParser());
        for (Document document : documents_02) {
            System.out.println("===================");
...
// 从一个目录及其子目录中加载所有文档
//        List<Document> documents_03 = FileSystemDocumentLoader.loadDocumentsRecursively(rootPath, new TextDocumentParser());
    }
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument(rootPath+"/人工智能.md");
